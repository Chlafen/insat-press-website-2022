...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="font-family:Montserrat, sans-serif"> 
 <head> 
  ...
  <title>New email template 2022-04-18</title><!--[if (mso 16)]>
    <style type="text/css">
                 ...
                 <tr> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:660px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="center" style="padding:0;Margin:0;font-size:0px; margin-bottom:1rem;"><img src="https://wbvhiz.stripocdn.email/content/guids/e4083f39-1525-4b06-86ca-6c14ac5c2676/images/logosvg.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="85" height="85"></td> 
                     </tr> 
                     <tr> 
                     ...
                     <tr> 
                      <td align="center" class="es-m-txt-l" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><span class="es-button-border" style="border-style:solid;border-color:#b7c9df;background:#18364e;border-width:4px;display:inline-block;border-radius:2px;width:auto"><a href=${url} class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#f3eded;font-size:16px;border-style:solid;border-color:#18364e;border-width:10px 30px 10px 30px;display:inline-block;background:#18364e;border-radius:2px;font-family:Montserrat, sans-serif;font-weight:bold;font-style:normal;line-height:19px;width:auto;text-align:center">Verify my email</a></span></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
